...
// Include lora simplified library
#include <SPI.h>  
// Include the SX1272
#include "SX1272.h"
// IMPORTANT
...
//
//#define ETSI_EUROPE_REGULATION //A Utiliser en France,(Europe)
#define FCC_US_REGULATION //A Utiliser au Canada,US, (America)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
// please uncomment only 1 choice
//#define BAND868 //A Utiliser en France,(Europe)
#define BAND900 //A Utiliser au Canada,US, (America)
//#define BAND433
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void Lora_init(void){
	...
	/*The following was included in the loop, but happened only once in original code...*/
	//uint8_t r_size;
	//int e;
...
void Lora_send_string(char * string){

	//Message to send. 100 characters maximum.
	uint8_t message[100];

	//r_size=sprintf((char*)message, "\\!Value of i is : %d", i);
	r_size=sprintf((char*)message, string);
